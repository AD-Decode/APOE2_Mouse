...
parser.add_argument('--dataroot', type=str, default='/home/alex/hsm/GNN/BrainGNN_Pytorch/data/ABIDE_pcp/cpac/filt_noglobal', help='root directory of the dataset')
...
tr_index_arr,val_index_arr,te_index_arr = train_val_test_split(fold=fold)

tr_index = tr_index_arr.tolist()
val_index = val_index_arr.tolist()

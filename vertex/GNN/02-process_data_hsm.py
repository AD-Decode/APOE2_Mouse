...
import pandas as pd
import numpy as np
from imports.preprocess_data import get_ids, get_subject_score, get_networks
import deepdish as dd
import warnings
import os

warnings.filterwarnings("ignore")
root_folder = '/home/alex/hsm/GNN/BrainGNN_Pytorch/data/'
#data_folder = os.path.join(root_folder, 'ABIDE_pcp/cpac/filt_noglobal/')
data_folder = os.path.join(root_folder, 'APOE2/full_connect/age_vertex_332_sd')
...
def main():
    ...
    parser.add_argument('--atlas', default='cc332',
    ...
    subject_IDs = get_ids(root_folder,data_folder)
    labels = get_subject_score(subject_IDs, score='AGE_GROUP')
    ...
    fea_corr = get_networks(subject_IDs, iter_no='', kind='connectivity', atlas_name=atlas,data_folder=data_folder) #(1035, 200, 200)
    fea_pcorr = get_networks(subject_IDs, iter_no='', kind='connectivity', atlas_name=atlas,data_folder=data_folder) #(1035, 200, 200)
